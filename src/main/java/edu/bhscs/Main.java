...
public class Main {
  public static void main(String[] args) {
    ...
    //   System.out.println("\nWelcome, " + name + "! You have $" + balance + " in your bank
    // account.");
    ...
    //     String flavor =
    //         player.ask("Choose a cake flavor (chocolate / vanilla / strawberry / lemon /
    // rhubarb): ");
    ...
    //       frosting =
    //           player.ask(
    //               "Choose frosting (chocolate / vanilla / strawberry / lemon / rhubarb /
    // blueberry): ");
