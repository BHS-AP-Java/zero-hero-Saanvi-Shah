...
public class Main {
  public static void main(String[] args) {
    ...
    // FIXED: Use playerChoice to assign name and balance
    if (playerChoice == 1) {
      name = "Player 1";
      startingBalance = 100;
    ...
    // FIXED: Baker has two constructors - use the one that takes String
    Baker baker = new Baker("Chef");
    baker.f = new Flour("All-purpose flour", 5);

    System.out.println("\nPlayer " + playerChoice + " (" + name + ") created!");
    System.out.println("Starting balance: $" + startingBalance);
    System.out.println("Bakery: " + bakery.getName());
    System.out.println("Supporting: " + ptsa.name + " PTSA");

    // Use the baker to bake a cake
    Cake myCake = baker.bakes(3, name);
